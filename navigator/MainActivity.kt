package com.example.navigatorkt
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {  //네비게이션 클릭시 수행
        when (item.itemId)
        {
            R.id.access -> startActivity(Intent(applicationContext,Sub::class.java))
